...
#   И проверить, какая версия является последним стабильным релизом
   Тогда я скачиваю последний стабильный релиз
   И проверяю что файл находится в нужной директории
#    #И проверяю что имя скачанного файла совпадает с именем файла-установщика
   Тогда удаляю загруженный файл
