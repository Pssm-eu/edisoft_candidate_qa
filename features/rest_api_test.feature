...
#   Тогда добавляю пользователя c логином t.task_eu6 именем testing фамилией task паролем Qwerty123@
#    И нахожу пользователя с логином t.task_eu1
    И удаляю пользователя с логином t.task_ustal_p2
#   И нахожу пользователя с логином t.task_eu5